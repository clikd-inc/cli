...
mod tests {
    ...
    fn test_container_status_unhealthy() {
        ...
        // Unknown
        let input = State::from(("clikd", &healthy));
    ...
    fn test_logsearch_from() {
        ...
        assert_eq!(
            ...
            LogSearch {
                ...
                buttons: Some(crate::core::status::app_data::LogsButton::Previous)
            }
        );
        ...
        assert_eq!(
            ...
            LogSearch {
                ...
                buttons: Some(crate::core::status::app_data::LogsButton::Both)
            }
        );
        ...
        assert_eq!(
            ...
            LogSearch {
                ...
                buttons: Some(crate::core::status::app_data::LogsButton::Next)
            }
        );
